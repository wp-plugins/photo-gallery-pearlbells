...
2. Upload the folder named `pearl_lightbox` to the `/wp-content/plugins/` directory.
...
= Can I change the background colour of the lightbox? =

  Yes you can customise it from the backend.
 

= Can I set the number of thumbnails in a row? =

   Yes you can set it as you wish.
